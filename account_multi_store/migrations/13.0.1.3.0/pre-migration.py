...
def migrate(cr, version):
    ...
    The BI integration was moved to account_multi_store_bi_financial so
    account_multi_store no longer requires bi_financial_pdf_reports.
    ...
    cr.execute(
        ...
        SELECT res_id
          FROM ir_model_data
         WHERE module = 'account_multi_store'
